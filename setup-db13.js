...
// Try direct connection (not pooler) - this is the format for Supabase
// The pattern is: [project-ref].supabase.co
const pool = new Pool({
  host: 'db.pgveqfawikvwqifsvsrx.supabase.co',
  port: 5432,
  database: 'postgres',
  user: 'postgres',
  password: 'Passwordforchad1996',
