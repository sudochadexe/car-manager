...
// Try the exact connection string format from the instructions
// NOTE: Password has a trailing dot in the original string
const pool = new Pool({
  connectionString: 'postgresql://postgres.pgveqfawikvwqifsvsrx:Passwordforchad1996.@aws-0-us-east-1.pooler.supabase.com:6543/postgres?sslmode=require',
  ssl: {
