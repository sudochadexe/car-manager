...
// Try with default postgres user (sometimes Supabase accepts this)
const pool = new Pool({
  connectionString: 'postgresql://postgres:Passwordforchad1996@aws-0-us-east-1.pooler.supabase.com:6543/postgres?sslmode=disable',
});
